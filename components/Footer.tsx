...
export default function Footer() {
  const socialMedia = [
    {
      name: "Facebook",
      icon: "/images/icons/facebook-white.png",
      href: "https://www.facebook.com/tembi.rumahbudaya.75",
    },
    {
      name: "Instagram",
      icon: "/images/icons/instagram-white.png",
      href: "https://www.instagram.com/tembi.historicalhome",
    },
    {
      name: "TikTok",
      icon: "/images/icons/tiktok-white.png",
      href: "https://www.tiktok.com/@tembi.historicalhome",
    },
  ];
  ...
  return (
    <footer className="bg-[#0F1623] text-gray-300 pt-16 pb-8 font-sans">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-400">
            <li className="flex items-start">
              <MapPin
                size={18}
                className="mr-3 mt-0.5 shrink-0 text-white"
              />
              <span className="leading-relaxed">
                Jl. Parangtritis No.Km 8.4, Tembi, Timbulharjo, Kec. Sewon,
                Kabupaten Bantul, Daerah Istimewa Yogyakarta 55186
              </span>
            </li>
      ...
      <div className="border-t border-gray-800 mt-16 pt-8 text-center text-sm text-gray-500">
        <p>
          &copy;
          <span suppressHydrationWarning>{new Date().getFullYear()}</span> Tembi
          Rumah Budaya. All rights reserved.

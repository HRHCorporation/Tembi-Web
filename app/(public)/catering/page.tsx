...
export default function FoodPage() {
	...
	return (
		<main className="w-full min-h-screen bg-white overflow-x-hidden">
			...
			>
				<div className="absolute inset-0 z-0">
					{bannerLoading ? (
						...
						<>
							<Image
								src={foodBanner?.image || "/images/foods/foodcover.webp"}
								alt={foodBanner?.title_ind || "Javanese Cuisine Spread"}
								fill
			...
			<section className="py-24 px-6 sm:px-12 lg:px-24 max-w-350 mx-auto bg-white">
			...
			<section className="py-24 px-6 sm:px-12 lg:px-24 max-w-full bg-white">
				<div className="max-w-7xl mx-auto">
					<div className="text-center max-w-3xl mx-auto mb-20">
						...
						<h2 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 mb-6">
							{t.foods.menus.title[0]}
							<span className="text-[#8F9E75]">{t.foods.menus.title[0]}</span>
						</h2>
								...
								<div className="flex items-start gap-4 mb-4">
									...
									<div>
										<h4 className="font-serif font-bold text-lg text-gray-900">
											{t.foods.gen.card.title}
										</h4>
										<p className="text-xs text-gray-500">
											{t.foods.gen.card.subtitle}
										</p>
									</div>
								</div>

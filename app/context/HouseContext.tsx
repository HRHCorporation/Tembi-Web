...
export function HouseProvider({ children }: { children: React.ReactNode }) {
	...
	const [houseSlug, setHouseSlug] = useState<RoomList | null>(null);
	...
	const loadHouseSlug = async (slug: string) => {
		if (!slug) {
	...
	const loadHouseRecommendation = async () => {

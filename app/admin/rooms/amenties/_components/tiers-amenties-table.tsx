...
import { useAmentiesList } from "../_hooks/use-tiers-amenties-list";
import { useDeleteAmentiesRoom } from "../_hooks/use-delete-amenties-room";
import {  } from "apexcharts";

export function AmentiesTable() {

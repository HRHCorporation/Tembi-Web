...
import { useCarouselList } from "../_hooks/use-carousel-list";
import { useDeleteCarousel } from "../_hooks/use-delete-carousel";
                ...
                <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/50">
                    <div className="rounded-lg p-6 shadow-lg w-80 space-y-4
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                            Apakah kamu yakin ingin menghapus carousel ini?
